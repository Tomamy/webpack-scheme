...
/******/ 			script.src = __webpack_require__.p + "" + ({"1":"pain","2":"webpack","3":"gulp","4":"demo","5":"addnote","6":"404"}[chunkId]||chunkId) + ".app-" + "908014" + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavisView = __webpack_require__(51);
	...
	function pathFinder(path){
		...
		switch(path){
			...
			case 'demo': 
				...
				break;
			case 'addnote': 
				handler = __webpack_require__(28);
				handler(function(app){
					app();	
				});
				break;
			...
			default:
				handler = __webpack_require__(44);
				handler(function(app){
					app();	
				});
				break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(3);
	var IndexView = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(3);
	var Backbone = __webpack_require__(1);
	var IndexModel = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavisView = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(3);
	var Backbone = __webpack_require__(1);
	var NavisModel = __webpack_require__(53);
	var NavisTemplate = __webpack_require__(54);
...
/***/ function(module, exports) {
	...
	module.exports = "<%_.each(navis,function(val){%>\n\t<%if(val.code != 'addnote'){%>\n\t\t<li class=\"<%=val.code%> <%= curpos == val.code || (!curpos && val.code == 'index') ? 'active':'' %>\"><a href=\"#<%=val.code%>\"><%=val.name%></a></li>\t\n\t<%}else {%>\n\t\t<li class=\"<%=val.code%> <%= curpos == val.code ? 'active': ''%>\"><a href=\"#<%=val.code%>\"  title=\"点击添加笔记\"><i class=\"glyphicon glyphicon-plus\"></i></a></li>\t\n\t<%}%>\n<%})%>\n";
